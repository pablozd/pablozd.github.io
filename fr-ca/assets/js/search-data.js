...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/fr-ca/";
          ...
          section: "menu de navigation",
          handler: () => {
            window.location.href = "/fr-ca/talks/";
          },
        ...
        handler: () => {
          ...
          description: "",
          section: "actualités",},{id: "news-crash-course-herramientas-de-inteligencia-artificial-para-la-docencia-universitaria-universidad-de-la-rioja-with-fernando-carranza-and-carlos-muñoz-pérez-from-10-13-2025-to-10-17-2025-and-from-10-20-2025-to-10-24-2025",
